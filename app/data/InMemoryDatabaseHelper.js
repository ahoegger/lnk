 ...
 */
var getNewId = function(dataArray, idProperty) {
    var maxValue = -1;
 ...
 * @return {number}
 */
var findPositionById = function(dataArray, idProperty, idValue) {
    if(!checkLoopProperties(dataArray, idProperty)) {
        return;
    }
    for (var i = 0, len = dataArray.length; i < len; i += 1) {
...
module.exports = inMemoryDatabaseHelper;